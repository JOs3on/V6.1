...
// Add Serum-specific addresses to the tokenData
async function addSerumAddresses(tokenData, accounts, accountIndices) {
    try {
        const serumKeys = {
            ...
            marketBaseVault: accounts[accountIndices[18]], //vault holding the base token in the Serum market
            marketQuoteVault: accounts[accountIndices[19]], //vault holding SOL in the Serum market
            marketAuthority: accounts[accountIndices[20]], //account that authorizes transactions on the Serum market
        };
